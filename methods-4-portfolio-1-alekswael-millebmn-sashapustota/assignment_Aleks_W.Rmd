...
\[P, N, P, P, N, P, P, N, N, N, P, P, N, P, P, N, N, P, N, P\] 11 P, 9 N

- Uninfected:

\[P, N, N, P, N, P, P, N, N, N, P, N, N, N, N, P, P, N, N, N\] 7 P, 13 N
...
posterior <- posterior / sum(posterior)
set.seed(100)
samples_not <- sample( p_grid , prob=posterior , size=1e4 , replace=TRUE )
...
```{r}
HPDI(samples_infected, prob = 0.95)
HPDI(samples_not, prob = 0.95)
```
...
```{r}
chainmode(samples_infected)
chainmode(samples_not)
```
